...
# node_dict = {  # kluczem jest ID wezla
...
# }
# poi_list = [
#     {"id": "1", "pose": (13, 24), "type": gc.base_node_type["load-unload-dock"]},
#     {"id": "2", "pose": (9, 13), "type": gc.base_node_type["load-unload-dock"]},
#     {"id": "3", "pose": (20, 18), "type": gc.base_node_type["load-unload-dock"]},
#     {"id": "4", "pose": (20, 8), "type": gc.base_node_type["load-unload"]},
#     {"id": "5", "pose": (27, 15), "type": gc.base_node_type["load-unload"]},
#     {"id": "6", "pose": (29, 23), "type": gc.base_node_type["load-unload"]},
#     {"id": "7", "pose": (7, 20), "type": gc.base_node_type["load-unload"]},
#     {"id": "8", "pose": (5, 6), "type": gc.base_node_type["load-unload"]},
#     {"id": "9", "pose": (14, 6), "type": gc.base_node_type["load-unload"]},
#     {"id": "10", "pose": (28, 8), "type": gc.base_node_type["load-unload-dock"]},
#     {"id": "11", "pose": (33, 18), "type": gc.base_node_type["load-unload"]},
#     {"id": "12", "pose": (11, 16), "type": gc.base_node_type["parking"]},
#     {"id": "13", "pose": (13, 16), "type": gc.base_node_type["parking"]},
#     {"id": "14", "pose": (17, 1), "type": gc.base_node_type["parking"]},
#     {"id": "15", "pose": (20, 1), "type": gc.base_node_type["parking"]},
#     {"id": "16", "pose": (24, 1), "type": gc.base_node_type["parking"]},
#     {"id": "17", "pose": (17, 12), "type": gc.base_node_type["queue"]},
#     {"id": "18", "pose": (26, 25), "type": gc.base_node_type["queue"]},
#     {"id": "19", "pose": (32, 3), "type": gc.base_node_type["charger"]}
# ]


node_dict = {
    1607594304577: {'pos': (6.664062500000028, 3.4140625), 'type': {'id': 13, 'nodeSection': 4}, 'name': None,
                    'poiId': '0'},
    1607594306058: {'pos': (6.07968759536746, 4.395572900772123), 'type': {'id': 13, 'nodeSection': 4}, 'name': None,
                    'poiId': '0'},
    1607594286435: {'pos': (4.808722614207568, -9.148006298694895), 'type': {'id': 4, 'nodeSection': 2}, 'name': None,
                    'poiId': '5f2d24c26783370e199b0a9b'},
    1607594291862: {'pos': (1.6171875, -13.4375), 'type': {'id': 8, 'nodeSection': 3}, 'name': None, 'poiId': '0'},
    1607956000665: {'pos': (0.68359375, 0.1601562500000142), 'type': {'id': 9, 'nodeSection': 3}, 'name': None,
                    'poiId': '0'},
    1607594286429: {'pos': (6.297854758513282, -2.803682235082192), 'type': {'id': 1, 'nodeSection': 1}, 'name': None,
                    'poiId': '5f2d23fd6783370e199b0a95'},
    1607956060319: {'pos': (4.677734375, -12.467773437499986), 'type': {'id': 13, 'nodeSection': 4}, 'name': None,
                    'poiId': '0'},
    1607594301729: {'pos': (6.282812595367432, -1.1981770992279053), 'type': {'id': 14, 'nodeSection': 5}, 'name': None,
                    'poiId': '0'},
    1607594286434: {'pos': (-0.19043212151876787, 0.11905512499851056), 'type': {'id': 4, 'nodeSection': 2},
                    'name': None, 'poiId': '5f2d24a46783370e199b0a9a'},
    1607594297123: {'pos': (1.78281259536746, -5.213802099227905), 'type': {'id': 13, 'nodeSection': 4}, 'name': None,
                    'poiId': '0'},
    1607594286436: {'pos': (1.59018531502376, -14.243276153280874), 'type': {'id': 3, 'nodeSection': 2}, 'name': None,
                    'poiId': '5f2d24d56783370e199b0a9c'},
    1607956038833: {'pos': (6.292968750000028, -1.7578125), 'type': {'id': 9, 'nodeSection': 3}, 'name': None,
                    'poiId': '0'},
    1607956370989: {'pos': (1.63671875, -13.453125), 'type': {'id': 9, 'nodeSection': 3}, 'name': None, 'poiId': '0'},
    1607594295471: {'pos': (4.68906259536746, -12.479427099227905), 'type': {'id': 13, 'nodeSection': 4}, 'name': None,
                    'poiId': '0'},
    1607594307249: {'pos': (1.6875000000000284, 4.2578125), 'type': {'id': 13, 'nodeSection': 4}, 'name': None,
                    'poiId': '0'},
    ...
    1607594299704: {'pos': (1.3125000000000142, 0.234375), 'type': {'id': 14, 'nodeSection': 5}, 'name': None,
                    'poiId': '0'},
    ...
    1607594293435: {'pos': (4.734375000000028, -10.921875), 'type': {'id': 8, 'nodeSection': 3}, 'name': None,
                    'poiId': '0'}
}
...
poi_list = [{'name': 'S1', 'standStatus': {'id': None, 'name': None}, 'id': '5f2d23fd6783370e199b0a95',
             'standType': {'id': '5fd0f08546229e620b22e95c', 'type': 1, 'name': 'Ładowarka'},
             'pose': {'position': {'y': -2.803682235082192, 'x': 6.297854758513267, 'z': 0.0},
                      'orientation': {'y': 0.0, 'x': 0.0, 'z': 0.7071067811865475, 'w': 0.7071067811865476}},
             'parkingType': {'id': '5e1f80725e1bdf5fe72d07b8', 'name': 'zgrubne'}},
            {'name': 'S2', 'standStatus': {'id': None, 'name': None}, 'id': '5f2d24466783370e199b0a97',
             'standType': {'id': '5fd0f10b46229e620b22e963', 'type': 12, 'name': 'Kolejka'},
             'pose': {'position': {'y': 3.232706431213259, 'x': 6.653100044672243, 'z': 0.0},
                      'orientation': {'y': 0.0, 'x': 0.0, 'z': 0.7170113900734976, 'w': 0.697061451024851}},
             'parkingType': {'id': '5e19e3b19d0ce61f6f234109', 'name': 'exact parking'}},
            {'name': 'S4', 'standStatus': {'id': None, 'name': None}, 'id': '5f2d24a46783370e199b0a9a',
             'standType': {'id': '5fd0f0c246229e620b22e95f', 'type': 4, 'name': 'Uniwersalne'},
             'pose': {'position': {'y': 0.11905512499849635, 'x': -0.19043212151876787, 'z': 0.0},
                      'orientation': {'y': 0.0, 'x': 0.0, 'z': 0.0, 'w': 1.0}},
             'parkingType': {'id': '5e1f80725e1bdf5fe72d07b8', 'name': 'zgrubne'}},
            {'name': 'E10', 'standStatus': {'id': None, 'name': None}, 'id': '5f2d24c26783370e199b0a9b',
             'standType': {'id': '5fd0f0c246229e620b22e95f', 'type': 4, 'name': 'Uniwersalne'},
             'pose': {'position': {'y': -9.148006298694895, 'x': 4.808722614207568, 'z': 0.0},
                      'orientation': {'y': 0.0, 'x': 0.0, 'z': -0.703486084021844, 'w': 0.7107090329998705}},
             'parkingType': {'id': '5e19e3b19d0ce61f6f234109', 'name': 'exact parking'}},
            {'name': 'S5', 'standStatus': {'id': None, 'name': None}, 'id': '5f2d24d56783370e199b0a9c',
             'standType': {'id': '5fd0f0a446229e620b22e95e', 'type': 3, 'name': 'Rozładunkowe'},
             'pose': {'position': {'y': -14.243276153280874, 'x': 1.59018531502376,
...
graf = gc.SupervisorGraphCreator(node_dict, edge_dict, poi_list)
print("wezly grafu")
